...
public class SoundManager : SingletonBase<SoundManager>
{
   ...
   [SerializeField] private AudioSource musicSource;
    ...
    {
        musicGame = Resources.LoadAll<AudioClip>("Sound/Music");
        sfxList = Resources.LoadAll<AudioClip>("Sound/Effect");

        PlayMusic(musicGame[1]);
    ...
    public void PlayMusic(AudioClip clip)
    {
        ...
        musicSource.volume = PlayerPrefs.GetFloat(StringManager.musicSave, 0.7f);
        musicSource.Play();
